...
def run(imglistfile, dataset_dir, output_dir, name='voc_train', shuffling=True):
    ...
    #read imglist from file
    infilename = os.path.join(dataset_dir, DIRECTORY_ImageSets, imglistfile)
    filenames = []
